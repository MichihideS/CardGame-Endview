...
struct CardDeck {
    let deckOfCards: [Card] = [
        Card(name: "Water Strike", attack: 3, defense: 0, cost: 2, special: DROWN, image: "water_strike", color: Color(.blue)),
        Card(name: "Water Strike", attack: 3, defense: 0, cost: 2, special: DROWN, image: "water_strike", color: Color(.blue)),
        Card(name: "Water Strike", attack: 3, defense: 0, cost: 2, special: DROWN, image: "water_strike", color: Color(.blue)),
        Card(name: "Swift Strike", attack: 10, defense: 0, cost: 4, special: WIND, image: "swift_strike", color: Color(.green)),
        Card(name: "Swift Strike", attack: 10, defense: 0, cost: 4, special: WIND, image: "swift_strike", color: Color(.green)),
        Card(name: "Swift Strike", attack: 10, defense: 0, cost: 4, special: WIND, image: "swift_strike", color: Color(.green)),
        Card(name: "Fiery Wave", attack: 5, defense: 0, cost: 3, special: BURN, image: "fiery_wave", color: Color(.red)),
        Card(name: "Fiery Wave", attack: 5, defense: 0, cost: 3, special: BURN, image: "fiery_wave", color: Color(.red)),
        Card(name: "Fiery Wave", attack: 5, defense: 0, cost: 3, special: BURN, image: "fiery_wave", color: Color(.red)),
        Card(name: "Massive Wall", attack: 0, defense: 10, cost: 3, special: 0, image: "massive_wall", color: Color(.gray)),
        Card(name: "Massive Wall", attack: 0, defense: 10, cost: 3, special: 0, image: "massive_wall", color: Color(.gray)),
        Card(name: "Massive Wall", attack: 0, defense: 10, cost: 3, special: 0, image: "massive_wall", color: Color(.gray)),
        ...
        Card(name: "Small Paper", attack: 0, defense: 3, cost: 2, special: 0, image: "small_paper", color: Color(.gray)),
        Card(name: "Small Paper", attack: 0, defense: 3, cost: 2, special: 0, image: "small_paper", color: Color(.gray)),
        Card(name: "Pen of Hell", attack: 20, defense: 0, cost: 7, special: 0, image: "pen_of_hell", color: Color(.gray)),
        Card(name: "Pen of Hell", attack: 20, defense: 0, cost: 7, special: 0, image: "pen_of_hell", color: Color(.gray)),
        Card(name: "Pen of Hell", attack: 20, defense: 0, cost: 7, special: 0, image: "pen_of_hell", color: Color(.gray)),
        ...
        Card(name: "Sword of Light", attack: 5, defense: 0, cost: 5, special: BLIND, image: "sword_of_light", color: Color(.orange)),
        Card(name: "Sword of Light", attack: 5, defense: 0, cost: 5, special: BLIND, image: "sword_of_light", color: Color(.orange)),
        Card(name: "Phoenix", attack: 8, defense: 0, cost: 6, special: BLIND, image: "phoenix", color: Color(.orange)),
        Card(name: "Phoenix", attack: 8, defense: 0, cost: 6, special: BLIND, image: "phoenix", color: Color(.orange)),
        Card(name: "Phoenix", attack: 8, defense: 0, cost: 6, special: BLIND, image: "phoenix", color: Color(.orange))
    ]
}
